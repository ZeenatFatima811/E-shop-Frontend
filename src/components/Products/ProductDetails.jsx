...
import { getAllProductsShop, getdata } from "../../redux/actions/product";
...
const ProductDetails = ({ data, isEvent = false }) => {
  ...
  const shopId = shopData?._id || shopData;
  ...
  }, [dispatch, shopId, data?._id, wishlist]);
  ...
  const handleMessageSubmit = async () => {
    if (isAuthenticated) {
      ...
      const sellerId = data?.shopId?._id;
      await axios
        ...
        <div className={`${styles.section} w-[90%] 800px:w-[80%]`}>
          <div className="w-full py-5">
            <div className="block w-full 800px:flex">
              ...
              <div className="w-full 800px:w-[50%] pt-0">
                ...
                <div className="flex items-center mt-3 justify-between pr-3">
                  <div>
                    <button
                ...
                <div className="flex items-center pt-8">
                  <Link to={`/shop/preview/${shopData?._id}`}>
                    <img
                  ...
                  <div
                    className={`${styles.button} !bg-[#C59B6D] hover:!bg-[#E76F51] mt-4 rounded h-11`}
...
const ProductDetailsInfo = ({
  ...
  return (
    <div className="bg-[#f5f6fb] px-3 800px:px-10 py-2 rounded">
      ...
      {active === 2 ? (
        <div className="w-full min-h-[40vh] flex flex-col items-center py-2 overflow-y-scroll">
          ...
          <div className="w-full flex justify-center">
            {reviews.length === 0 && (
              <h5>No Reviews have for this {isEvent ? "event" : "product"}</h5>
            )}
          </div>
        </div>
      ) : null}
          ...
          <div className="w-full 800px:w-[50%]">
            <Link to={`/shop/preview/${shopData?._id}`}>
              <div className="flex items-center">
                ...
                />
                <div className="pl-3">
                  <h3 className={`${styles.shop_name}`}>{shopData?.name}</h3>
            ...
            <p className="pt-2">{shopData?.description}</p>
          </div>
