    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      ...
      {open && (
        <div className="w-full fixed top-0 left-0 h-screen bg-[#0005] z-[50] flex items-center justify-center">
          <div className="w-[60%] h-min bg-[#fff] shadow rounded-md pl-3 pr-3">
            ...
            <div className="w-full ml-3">
              ...
              <textarea
                ...
                className="mt-1 w-[95%] border p-2 outline-none"
              ></textarea>
            </div>
            <div
      ...
      <br />
      <Link to="/">
        <div className={`${styles.button} text-[#fff]`}>Send Message</div>
      </Link>
      <br />
      <br />
    </div>
